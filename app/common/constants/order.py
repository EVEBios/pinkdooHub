...
# Experience/固定 Kit 行与颜色 Kit 行使用独立上限；混合订单最多 30 行。
ORDER_NON_COLOR_ITEMS_MAX_COUNT = 10
ORDER_COLOR_ITEMS_MAX_COUNT = 20
ORDER_ITEMS_MAX_COUNT = (
    ORDER_NON_COLOR_ITEMS_MAX_COUNT + ORDER_COLOR_ITEMS_MAX_COUNT
)
ORDER_ITEM_QUANTITY_MIN = 1
ORDER_ITEM_QUANTITY_MAX = 99
ORDER_REMARK_MAX_LENGTH = 500
ORDER_KIT_COLOR_CODE_MAX_LENGTH = BEAD_COLOR_CODE_MAX_LENGTH
ORDER_KIT_COLOR_NAME_MAX_LENGTH = BEAD_COLOR_NAME_MAX_LENGTH
ORDER_KIT_COLOR_SLOT_MIN = BEAD_COLOR_SLOT_MIN
ORDER_KIT_COLOR_SLOT_MAX = BEAD_COLOR_SLOT_COUNT
ORDER_COLOR_SALE_UNIT_GRAMS = COLOR_SELECTABLE_SALE_UNIT_GRAMS
